...
/// api membershipbackage
export const MEMBERSHIP_PACKAGE_API = "/api/MemberShipPackage"
/// api blog
...
// api admin
export const ADMINMANAGER_API = "/api/AdminManager"
// api /api/AdminDashboard
export const ADMIN_DASHBOARDS_API = "/api/AdminDashboard"